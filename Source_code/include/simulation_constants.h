...
#define FIELD_PANEL_MAX_STR_LENGTH 255  /* Maximum length of the caption */
...
#define INFO_PANEL_MAX_STR_LENGTH 255  /* Maximum length of the caption */
...
#define PLOT_PANEL_MAX_STR_LENGTH 255  /* Maximum length of the caption */
